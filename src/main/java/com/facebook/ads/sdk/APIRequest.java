...
public class APIRequest<T extends APINode> {
    ...
    private static ResponseWrapper readResponse(HttpsURLConnection con) throws APIException, IOException {
        try {
            ...
            return handleError(con, e);
        }
    }

    private static ResponseWrapper handleError(HttpsURLConnection con, Exception e) throws IOException, APIException.FailedRequestException {
        final InputStream inputStream = Optional.ofNullable(con)
                .map(HttpURLConnection::getErrorStream)
                .orElse(null);
    ...
    public static class RequestHelper {
        ...
        public static ListenableFuture<ResponseWrapper> invoke(OkHttpClient client, okhttp3.Request request) {
